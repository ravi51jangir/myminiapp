...
const ICO = () => {
  ...
  const onUPCOMINGTextClick = () => {
    console.log("Upcoming clicked!");
    router.push("/upcoming-page"); // Replace with the actual route for the upcoming page
  };

  const onENDEDTextClick = () => {
    console.log("Ended clicked!");
    router.push("/ended-page"); // Replace with the actual route for the ended page
  };
  ...
  return (
    <div className={styles.ico3}>
      ...
      <b className={styles.upcoming} onClick={onUPCOMINGTextClick}>
        UPCOMING
      </b>
